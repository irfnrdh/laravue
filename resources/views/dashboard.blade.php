...
<head>
    ...
    <link rel="stylesheet" href="source/src/font/iconsmind-s/css/iconsminds.css" />
    <link rel="stylesheet" href="source/src/font/simple-line-icons/css/simple-line-icons.css" />

    <link rel="stylesheet" href="source/src/css/vendor/bootstrap.min.css" />
    <link rel="stylesheet" href="source/src/css/vendor/perfect-scrollbar.css" />
...
<body id="app-container" class="menu-default show-spinner">
                ...
                <ul class="list-unstyled" data-link="layouts">
                    ...
                    <li>
                        <a href="Pages.Mailing.html">
                            <i class="simple-icon-envelope-open"></i> Mailing
                        </a>
                    </li>
                    <li>
                        <a href="Pages.Invoice.html">
                            <i class="simple-icon-bag"></i> Invoice
                        </a>
                    </li>
                    <li>
                ...
                <ul class="list-unstyled" data-link="applications">
                    <li>
                        <a href="Apps.MediaLibrary.html">
                            <i class="simple-icon-picture"></i> Library
                        </a>
                    </li>
                    <li>
        ...
        <div class="container-fluid">
            <div class="row  ">
                <div class="col-12">
                    ...
                    Mulai
                    <route-link to='/foo'>Goto Foo</route-link>
    ...
    <script src="source/src/js/vendor/jquery-3.3.1.min.js"></script>
    <script src="source/src/js/vendor/bootstrap.bundle.min.js"></script>
    <script src="source/src/js/vendor/perfect-scrollbar.min.js"></script>
    <script src="source/src/js/vendor/mousetrap.min.js"></script>
    <script src="source/src/js/dore.script.js"></script>
    <script src="source/src/js/scripts.js"></script>
</body>
